...
namespace DomainSOSPet.Entities
{
    ...
    public class Usuario
    {
        public Usuario()
        {
            AchadoPerdidos = new HashSet<AchadoPerdidoPUT>();
        ...
        [InverseProperty(nameof(AchadoPerdidoPUT.IdUsuarioNavigation))]
        public virtual ICollection<AchadoPerdidoPUT> AchadoPerdidos { get; set; }
        [InverseProperty(nameof(AdocaoAnimal.IdUsuarioNavigation))]
        public virtual ICollection<AdocaoAnimal> AdocaoAnimals { get; set; }
        [InverseProperty(nameof(AnimalBASE.IdUsuarioNavigation))]
