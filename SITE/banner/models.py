...
class Banner(models.Model):
    ...
    banner = ProcessedImageField(verbose_name=u"Banner", upload_to="banners", processors=[ResizeToFill(1200, 700)], format='JPEG', options={'quality': 60}, help_text=u"Imagem do banner da home")
    ...
    slug = AutoSlugField(populate_from=u"title")
