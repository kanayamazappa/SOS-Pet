# Generated by Django 3.2.8 on 2021-10-18 15:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('castrated', models.BooleanField(default=0, help_text='Animal de estimação é castrado?', verbose_name='Castrado')),
                ('weight', models.PositiveSmallIntegerField(blank=True, help_text='Peso do animal de estimação', verbose_name='Peso')),
                ('height', models.PositiveSmallIntegerField(blank=True, help_text='Altura do animal de estimação', verbose_name='Altura')),
                ...
                ('coat', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pet.coat')),
                ('color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pet.color')),
        ...
        migrations.AddField(
            model_name='breed',
            name='specie',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pet.specie'),
        ),
    ]
